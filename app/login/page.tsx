...
function LoginForm() {
  ...
  useEffect(() => {
    if (state.redirectTo) {
      try {
        // First validate if it's a valid URL or path
        if (state.redirectTo.startsWith("/")) {
          // For relative paths
          window.location.href = state.redirectTo;
        } else {
          // For absolute URLs, validate first
          new URL(state.redirectTo); // This will throw if invalid
          window.location.href = state.redirectTo;
        }
      } catch (error) {
